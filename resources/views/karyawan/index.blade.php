                                ...
                                <div class="row">
                                    <div class="col-6 card-header py-5">
                                        <div class="input-group">
                                            <input name="cari" class="form-control" type="search" placeholder="Nama Karyawan" aria-label="Search" value="{{ Request('cari') }}">
                    ...
                    <div class="row">
                        <div class="col-12">
                            <div class="input-icon mb-3">
                                ...
                                <input type="text" value="" id="nip" class="form-control" placeholder="NIP" name="nip">
                            </div>
                        </div>
                    </div>
                    <div class="row">
    ...
    <div class="modal-dialog modal-dialog-centered" role="document">
        <div class="modal-content">
            ...
            <div class="modal-body" id="loadeditform">
                <form action="/karyawan/edit" method="POST" id="frmKaryawan" enctype="multipart/form-data">
                    @csrf
                    <div class="row">
                        <div class="col-12">
                            <div class="input-icon mb-3">
